//
//  AppointmentCreateFailureBottomSheet.swift
//  Lunchat
//
...
final class AppointmentCreateFailure: DefaultBaseBottomSheet {
    ...
    private func setConfig() {
        titleLabel.text = "밥약 생성에 실패 했습니다"
        detailLabel.text = "밥약 생성에 실패 하였습니다.\n잠시후 다시 밥약 생성을 시도해 주시기 바랍니다."
    }

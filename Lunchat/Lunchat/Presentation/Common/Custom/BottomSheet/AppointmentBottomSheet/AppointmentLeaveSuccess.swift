//
//  AppointmentExitSuccess.swift
//  Lunchat
//
//  Created by 이경후 on 2023/07/02.
//

import UIKit
import RxSwift

final class AppointmentLeaveSuccess: DefaultBaseBottomSheet {
    ...
    private func setConfig() {
        titleLabel.text = "밥약 나가기가 완료되었습니다."
        detailLabel.text = "나간 밥약은 다시 참여하기가 불가능합니다."
    }
    ...
    private func setConstraints() {
        ...
        contentView.snp.makeConstraints { make in
            make.height.equalTo(234 + bottomInset)

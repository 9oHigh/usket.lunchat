//
//  AppointmentCreateSuccessBottomSheet.swift
//  Lunchat
//
...
final class AppointmentCreateSuccess: DefaultBaseBottomSheet {
    ...
    private func setConfig() {
        titleLabel.text = "밥약 생성이 완료 되었습니다"
        detailLabel.text = "밥약 생성이 완료 되었습니다. 생성된 밥약은 메인홈, 내가 참여하고 있는 밥약에서 확인이 가능합니다."
    }

//
//  AppointmentCancelBottomSheet.swift
//  Lunchat
//
...
final class AppointmentCancel: DefaultBaseBottomSheet {
    ...
    private func setConfig() {
        titleLabel.text = "밥약을 취소하시겠습니까?"
        detailLabel.text = "밥약을 취소하게 될경우 다시 참여할 수 없음으로 신중하게 선택해 주시기 바랍니다."
    }

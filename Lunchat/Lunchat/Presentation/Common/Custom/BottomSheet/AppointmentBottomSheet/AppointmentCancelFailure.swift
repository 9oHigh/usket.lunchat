//
//  AppointmentCancelFailureBottomSheet.swift
//  Lunchat
//
...
final class AppointmentCancelFailure: DefaultBaseBottomSheet {
    ...
    private func setConfig() {
        titleLabel.text = "밥약 취소에 실패했습니다"
        detailLabel.text = "밥약 취소에 실패했습니다.\n일시적인 오류일수 있음으로\n잠시후 다시시도해 주시기 바랍니다."
    }

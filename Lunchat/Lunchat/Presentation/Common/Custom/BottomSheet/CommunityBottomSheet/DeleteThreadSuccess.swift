//
//  DeleteThreadSuccess.swift
//  Lunchat
//
//  Created by 이경후 on 2023/09/26.
//

import UIKit
import RxSwift

final class DeleteThreadSuccess: DefaultBaseBottomSheet {
    ...
    private func setConfig() {
        titleLabel.text = "쓰레드 삭제가 완료되었습니다."
        detailLabel.text = "정상적으로 쓰레드 삭제가 완료되었습니다."
    }

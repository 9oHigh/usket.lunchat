//
//  ThreadPhotoUploadFailure.swift
//  Lunchat
//
...
final class ThreadPhotoUploadFailure: DefaultBaseBottomSheet {
    ...
    private func setConfig() {
        titleLabel.text = "사진 업로드에 실패했습니다."
        detailLabel.text = "알 수 없는 오류로 인해 업로드에 실패했습니다.\n잠시후 다시 시도해 주시기 바랍니다."
    }

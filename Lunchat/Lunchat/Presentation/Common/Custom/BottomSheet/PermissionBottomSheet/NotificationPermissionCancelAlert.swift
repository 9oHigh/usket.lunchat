//
//  NotificationPermissionCancelAlert.swift
//  Lunchat
//
...
final class NotificationPermissionCancelAlert: DefaultBaseBottomSheet {
    ...
    private func setConfig() {
        titleLabel.text = "알림 접근 권한을 취소하시겠습니까?"
        detailLabel.text = "접근을 허용해야 해당 기능을 이용할 수 있습니다."
    }

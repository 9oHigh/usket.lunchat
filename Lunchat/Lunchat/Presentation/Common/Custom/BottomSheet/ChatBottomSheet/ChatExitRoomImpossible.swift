...
final class ChatExitRoomImpossible: DefaultBaseBottomSheet {
    ...
    private func setConfig() {
        titleLabel.text = "채팅방 나가기 불가 안내"
        detailLabel.text = "참가하고 계신 밥약이 있을 경우,\n밥약 나가기를 통해 채팅방에서 나갈 수 있습니다."
    }

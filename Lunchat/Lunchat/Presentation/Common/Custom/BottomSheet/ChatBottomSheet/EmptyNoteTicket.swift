//
//  EmptyNoteTicket.swift
//  Lunchat
//
//  Created by 이경후 on 2023/05/29.
//

import UIKit
import RxSwift

final class EmptyNoteTicket: DefaultBaseBottomSheet {
    ...
    private func setConfig() {
        titleLabel.text = "보유하고있는 쪽지권이 없습니다"
        detailLabel.text = "쪽지구매를 위해 상품페이지로 이동하시겠습니까?"
    }

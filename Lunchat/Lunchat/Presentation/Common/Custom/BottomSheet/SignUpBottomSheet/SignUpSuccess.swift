//
//  SignUpSuccessBottomSheet.swift
//  Lunchat
//
...
final class SignUpSuccess: DefaultBaseBottomSheet {
    ...
    private func setConfig() {
        titleLabel.text = "회원가입이 완료되었습니다"
        detailLabel.text = "LunChat 회원 가입을 진심으로 축하드립니다."
    }

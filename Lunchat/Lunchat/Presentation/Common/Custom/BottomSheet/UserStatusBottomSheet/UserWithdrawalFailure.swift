...
final class UserWithdrawalFailure: DefaultBaseBottomSheet {
    ...
    private func setConfig() {
        titleLabel.text = "회원탈퇴에 실패했습니다."
        detailLabel.text = "일시적인 오류로 인해 회원탈퇴에 실패했습니다.\n잠시후 다시 시도해주세요."
    }

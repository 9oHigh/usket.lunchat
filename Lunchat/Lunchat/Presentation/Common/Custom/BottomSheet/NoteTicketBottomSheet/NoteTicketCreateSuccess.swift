//
//  CreateNoteSuccessBottomSheet.swift
//  Lunchat
//
...
final class NoteTicketCreateSuccess: DefaultBaseBottomSheet {
    ...
    private func setConfig() {
        titleLabel.text = "쪽지 충전이 완료되었습니다"
        detailLabel.text = "쪽지 충전이 완료되었습니다.\n쪽지 사용법은 쪽지 이용안내를 통해 확인해 주시기 바랍니다."
    }

//
//  AppointmentLocationViewController.swift
//  Lunchat
//
...
final class AppointmentLocationViewController: BaseViewController {
    ...
    private func bind() {
        ...
        viewModel.searchedPlaces
            .withUnretained(self)
            .compactMap { owner, searchedPlace in
                owner.hideLoadingView(0.25)

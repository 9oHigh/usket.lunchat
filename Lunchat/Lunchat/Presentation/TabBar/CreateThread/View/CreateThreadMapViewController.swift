//
//  CreateThreadMapViewController.swift
//  Lunchat
//
...
final class CreateThreadMapViewController: BaseViewController, NMFMapViewCameraDelegate {
    ...
    init(viewModel: CreateThreadViewModel, lat: Double, long: Double) {
